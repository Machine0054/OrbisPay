...
<!-- ========================================================= * Materio -  | v1.0.0 ============================================================== * Product Page: https://themeselection.com/item/materio-dashboard-pro-bootstrap/ * Created by: ThemeSelection * License: You must have a valid license purchased in order to legally use the theme for your project. * Copyright ThemeSelection (https://themeselection.com) =========================================================  -->
...
<html
  ...
  <head>
    ...
    <meta name="robots" content="noindex, nofollow" />
      ...
      <title>Demo: Dashboard - eCommerce | Materio - Bootstrap Dashboard PRO</title>
      ...
      <!-- Canonical SEO -->
        ...
        <script type="text/javascript" nonce="faffd926db0243798684ddeecfc" src="//local.adguard.org?ts=1757336364667&amp;type=content-script&amp;dmn=demos.themeselection.com&amp;app=brave.exe&amp;css=1&amp;js=1&amp;gcss=1&amp;rel=1&amp;rji=1&amp;sbe=0"></script>
<script type="text/javascript" nonce="faffd926db0243798684ddeecfc" src="//local.adguard.org?ts=1757336364667&amp;name=AdGuard%20Popup%20Blocker&amp;name=AdGuard%20Extra&amp;type=user-script"></script><link rel="canonical" href="https://themeselection.com/item/materio-dashboard-pro-bootstrap/" />
      <script>
        (function (w, d, s, l, i) {
          w[l] = w[l] || [];
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="../assets/vendor/fonts/iconify-icons.css" />
...
<aside id="layout-menu" class="layout-menu menu-vertical menu" >
  ...
  ">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          ...
          <div class="badge text-bg-danger rounded-pill ms-auto">4</div>
        </a>
        <ul class="menu-sub">
          <li class="menu-item">
        ...
        <div class="col-sm-6">
          <div class="card h-100">
            <div class="card-header d-flex align-items-center justify-content-between">
              ...
              <div class="dropdown">
                <button class="btn text-body-secondary p-0" type="button" id="transactionsID" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="icon-base ri ri-more-2-line icon-24px"></i>
                </button>
          ...
          <div class="col-md-5 border-start ps-md-0">
            ...
            <div class="card-header">
              <div class="d-flex justify-content-between">
                ...
                <div class="dropdown">
                  <button class="btn text-body-secondary p-0" type="button" id="totalProfit" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="icon-base ri ri-more-2-line icon-24px"></i>
                  </button>
              ...
              <div class="me-4">
                <div class="avatar flex-shrink-0">
                  <div class="avatar-initial bg-label-danger rounded">
                    <div>
                      <img src="../../assets/img/icons/unicons/paypal.svg" alt="paypal" class="img-fluid" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <li class="d-flex mb-4 pb-1">
              <div class="me-4">
                <div class="avatar flex-shrink-0">
                  <div class="avatar-initial bg-label-success rounded">
                    <div>
                      <img src="../../assets/img/icons/unicons/credit-card.svg" alt="paypal" class="img-fluid" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="me-4">
                <div class="avatar flex-shrink-0">
                  <div class="avatar-initial bg-label-warning rounded">
                    <div>
                      <img src="../../assets/img/icons/unicons/card-atm.svg" alt="paypal" class="img-fluid" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <li class="d-flex mb-4 pb-1">
              <div class="me-4">
                <div class="avatar flex-shrink-0">
                  <div class="avatar-initial bg-label-primary rounded">
                    <div>
                      <img src="../../assets/img/icons/unicons/wallet.svg" alt="paypal" class="img-fluid" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="me-4">
                <div class="avatar flex-shrink-0">
                  <div class="avatar-initial bg-label-info rounded">
                    <div>
                      <img src="../../assets/img/icons/unicons/arrow-growth.svg" alt="paypal" class="img-fluid" />
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="col-sm-6">
          <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
              ...
              <div class="dropdown">
                <button class="btn text-body-secondary p-0" type="button" id="logisticsID" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="icon-base ri ri-more-2-line icon-24px"></i>
                </button>
        ...
        <div class="col-sm-6">
          <div class="card h-100">
            <div class="card-header d-flex align-items-center justify-content-between">
              ...
              <div class="dropdown">
                <button class="btn text-body-secondary p-0" type="button" id="reportsID" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="icon-base ri ri-more-2-line icon-24px"></i>
                </button>
    ...
    <div class="col-xxl-4 col-md-6 ">
      <div class="card h-100">
        <div class="card-header d-flex align-items-center justify-content-between">
          ...
          <div class="dropdown">
            <button class="btn text-body-secondary p-0" type="button" id="webStatistics" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="icon-base ri ri-more-2-line icon-24px"></i>
            </button>
      ...
      <div class="card overflow-hidden h-100">
        <div class="table-responsive">
          <table class="table table-sm">
            ...
            <tbody>
              <tr>
                <td class="text-primary"><a href="./app-invoice-preview.njk">#4910</a></td>
                <td>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <h6 class="mb-0 text-truncate"><a href="pages-profile-user.njk" class="text-heading">Jordan Stevenson</a></h6>
              ...
              <tr>
                <td class="text-primary"><a href="./app-invoice-preview.njk">#4909</a></td>
                <td>
                  <div class="avatar avatar-sm">
                    <div class="avatar-initial bg-label-success rounded-circle">
                      <i class="icon-base ri ri-check-line icon-16px"></i>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <h6 class="mb-0 text-truncate"><a href="pages-profile-user.njk" class="text-heading">Richard Payne</a></h6>
              ...
              <tr>
                <td class="text-primary"><a href="./app-invoice-preview.njk">#4908</a></td>
                <td>
                  <div class="avatar avatar-sm">
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <h6 class="mb-0 text-truncate"><a href="pages-profile-user.njk" class="text-heading">Jennifer Summers</a></h6>
              ...
              <tr>
                <td class="text-primary"><a href="./app-invoice-preview.njk">#4907</a></td>
                <td>
                  <div class="avatar avatar-sm">
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <h6 class="mb-0 text-truncate"><a href="pages-profile-user.njk" class="text-heading">Mr. Justin Richardson</a></h6>
              ...
              <tr>
                <td class="text-primary"><a href="./app-invoice-preview.njk">#4906</a></td>
                <td>
                  <div class="avatar avatar-sm">
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <h6 class="mb-0 text-truncate"><a href="pages-profile-user.njk" class="text-heading">Nicholas Tanner</a></h6>
              ...
              <tr>
                <td class="text-primary"><a href="./app-invoice-preview.njk">#4905</a></td>
                <td>
                  <div class="avatar avatar-sm">
                    <div class="avatar-initial bg-label-secondary rounded-circle">
                      <i class="icon-base ri ri-mail-line icon-16px"></i>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <h6 class="mb-0 text-truncate"><a href="pages-profile-user.njk" class="text-heading">Crystal Mays</a></h6>
              ...
              <tr>
                <td class="text-primary"><a href="./app-invoice-preview.njk">#4904</a></td>
                <td>
                  <div class="avatar avatar-sm">
                    <div class="avatar-initial bg-label-success rounded-circle">
                      <i class="icon-base ri ri-check-line icon-16px"></i>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <h6 class="mb-0 text-truncate"><a href="pages-profile-user.njk" class="text-heading">Mary Garcia</a></h6>
              ...
              <tr class="border-transparent">
                <td class="text-primary"><a href="./app-invoice-preview.njk">#4903</a></td>
                <td>
                  <div class="avatar avatar-sm">
                    <div class="avatar-initial bg-label-info rounded-circle">
                      <i class="icon-base ri ri-arrow-down-line icon-16px"></i>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <h6 class="mb-0 text-truncate"><a href="pages-profile-user.njk" class="text-heading">Megan Roberts</a></h6>
  ...
  <div class="container-xxl">
    <div class="footer-container d-flex align-items-center justify-content-between py-4 flex-md-row flex-column">
      ...
      <div class="d-none d-lg-inline-block">
        ...
        <a href="https://themeselection.com/item/category/bootstrap-templates/" target="_blank" class="footer-link me-4">Bootstrap Dashboard</a>
...
<!-- / Layout wrapper -->
      ...
      <div class="buy-now">
        <a href="https://themeselection.com/item/materio-dashboard-pro-bootstrap/" target="_blank" class="btn btn-danger btn-buy-now">Buy Now</a>
      </div>
    ...
    <!-- Page JS -->
    <script src="../assets/vendor/js/app-ecommerce-dashboard.js"></script>
