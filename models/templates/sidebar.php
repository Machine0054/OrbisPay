<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        ...
        <div class="mb-6">
            <div class="px-3 mb-3">
                <span class="text-xs font-semibold text-gray-400 uppercase tracking-wider">Transacciones</span>
            </div>
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="registro_ingresos.php"
                        class="flex items-center sidebar-item p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo ($pagina_actual === 'registro_ingresos') ? 'active' : ''; ?>">
                ...
                <li>
                    <a href="registro_gastos.php"
                        class="flex items-center sidebar-item p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group <?php echo ($pagina_actual === 'registro_gastos') ? 'active' : ''; ?>">
                        <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 20 20">
                            <path
        ...
        <div class="mb-6">
            <div class="px-3 mb-3">
                <span class="text-xs font-semibold text-gray-400 uppercase tracking-wider">Análisis</span>
            </div>
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="reportes.php"
        ...
        <!-- Consejo (Tip Card) -->
        <!-- Consejo (Tip Card) - Versión Mejorada -->
        <div
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="flex-shrink-0">
                    <div
                        class="w-10 h-10 rounded-lg bg-blue-500 dark:bg-blue-600 flex items-center justify-center shadow-sm">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-xs text-gray-600 dark:text-gray-300 leading-relaxed">
                        Revisa tus gastos cada semana para mantener un mejor control de tus finanzas.
                    </p>
                </div>
            </div>
